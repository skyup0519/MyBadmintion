...
import com.example.andy.app_test.model.Jsoup_parser_html_service;
...
//      Observer end
    ...
    private void PageAdapter_working_start() {
        ...
        new Jsoup_parser_html_service().start();
        //裝入Adapter
...
//        viewPager.setPageTransformer(true,new ZoomOutPageTransformer());
 ...
 //     ViewPage start
    ...
    public void onPageSelected(int position) {
        TestLog.myLog_d(MAINMENU, "onPageSelected()");
        switch (position) {
            case 0:
                TestLog.myLog_d(MAINMENU, "onPageSelected 0");
                radioGroup.check(R.id.radioButton1);
                break;

            case 1:
                TestLog.myLog_d(MAINMENU, "onPageSelected 1" );
                radioGroup.check(R.id.radioButton2);
                break;

            case 2:
                TestLog.myLog_d(MAINMENU, "onPageSelected 2");
                radioGroup.check(R.id.radioButton3);
                break;

            case 3:
                TestLog.myLog_d(MAINMENU, "onPageSelected 3");
...
// 当前为第一张，此时从左向右滑，则切换到最后一张
    ...
    //RecyclerView onClick() (管理)按下後引發的事件
    @Override
    public void onItemClick(View view, int postion) {
        TestLog.myLog_d(MAINMENU, "RecycleView onItemClick");
        TestLog.myLog_d(MAINMENU, "postion",postion);
    ...
    public void onClick(DialogInterface dialog, int which) {
        TestLog.myLog_d(MAINMENU, "AlertDialog onClick");
        TestLog.myLog_w(MAINMENU, "MODE_BACK_MENU",MODE_BACK_MENU);
        TestLog.myLog_w(MAINMENU, "current_mode_typ",current_mode_typ);
        ...
        switch (which){
            ...
            case DialogInterface.BUTTON_POSITIVE:
                if(MODE_BACK_MENU == current_mode_typ){
                    TestLog.myLog_d(MAINMENU, "AlertDialog onClick","Posit MODE_BACK_MENU");
                    finish();
                    dialog.dismiss();
                    return;
                }
                ...
                if(MODE_UTIL_ERROR == current_mode_typ){
                    TestLog.myLog_d(MAINMENU, "AlertDialog onClick","Posit MODE_UTIL_ERROR");
                    return;
                }


                TestLog.myLog_d(MAINMENU, "AlertDialog onClick","Posit other");
                dialog.dismiss();
                break;

            case DialogInterface.BUTTON_NEGATIVE:
                if(MODE_BACK_MENU == current_mode_typ){
                    TestLog.myLog_d(MAINMENU, "AlertDialog onClick","nega MODE_BACK_MENU");
                ...
                TestLog.myLog_d(MAINMENU, "AlertDialog onClick","nega other");
                dialog.dismiss();
                break;
